...
-- 7. Liệt kê danh sách mua hàng bao gồm giá tiền của mỗi đơn hàng
...
-- 8. Liệt kê danh sách mua hàng, mỗi user chỉ lấy đơn hàng có giá trị lớn nhất
...
-- 9. Liệt kê danh sách mua hàng, mỗi user chỉ lấy đơn hàng có giá trị nhỏ nhất
SELECT user_id, user_name, order_id, total_price FROM (
    SELECT users.user_id, users.user_name, orders.order_id, SUM(products.product_price) AS total_price,
...
-- 10. Liệt kê danh sách mua hàng, mỗi user chỉ lấy đơn hàng có số sản phẩm nhiều nhất
